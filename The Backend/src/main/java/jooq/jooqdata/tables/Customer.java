...
public class Customer extends TableImpl<CustomerRecord> {
     ...
     */
    public final TableField<CustomerRecord, String> CUSTOMER_CODE = createField(DSL.name("customer_code"), SQLDataType.VARCHAR(10).nullable(false), this, "");
     ...
     */
    public final TableField<CustomerRecord, String> CUSTOMER_INN = createField(DSL.name("customer_inn"), SQLDataType.VARCHAR(12).nullable(false), this, "");

    /**
     * The column <code>purchase.customer.customer_kpp</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_KPP = createField(DSL.name("customer_kpp"), SQLDataType.VARCHAR(9).nullable(false), this, "");

    /**
     * The column <code>purchase.customer.customer_legal_address</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_LEGAL_ADDRESS = createField(DSL.name("customer_legal_address"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>purchase.customer.customer_postal_address</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_POSTAL_ADDRESS = createField(DSL.name("customer_postal_address"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>purchase.customer.customer_email</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_EMAIL = createField(DSL.name("customer_email"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>purchase.customer.customer_code_main</code>.
     */
    public final TableField<CustomerRecord, String> CUSTOMER_CODE_MAIN = createField(DSL.name("customer_code_main"), SQLDataType.VARCHAR(10).nullable(false), this, "");
    ...
    public List<UniqueKey<CustomerRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_CUSTOMER_CODE, Keys.UNIQUE_CUSTOMER_INN_KPP);
    }

    @Override
    public List<Check<CustomerRecord>> getChecks() {
        return Arrays.asList(
            Internal.createCheck(this, DSL.name("chk_customer_email"), "(((customer_email)::text ~~ '%@%'::text))", true)
        );
    }
